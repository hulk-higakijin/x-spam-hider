const { isInvestmentSpam, extractEmojis } = require("../content");
...
describe("extractEmojis", () => {
  ...
  test("複数の絵文字が混在する場合はカンマ区切りで返す", () => {
    const text = `パチンコを辞めたのは、もっと儲かることが知りました。
      @Barobaiduri
